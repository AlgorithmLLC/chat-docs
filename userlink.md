...
7. [Расшифровка сообщений от неавторизованных пользователей](/userlink.md#Расшифровка-сообщений-от-неавторизованных-пользователей)
...
После нажатия на кнопку активации глобального поиска в результатах поиска выводятся пользователи, которых нет в списке контактов:
...
#### Расшифровка сообщений от неавторизованных пользователей
